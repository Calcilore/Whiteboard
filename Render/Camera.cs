...
public static class Camera {
    ...
    public static float StaticZoom { get; private set; } // for making displays the same
    public static float TotalZoom => Zoom * StaticZoom; 
    ...
    public static Rectangle WindowBounds => Main.Game.Window.ClientBounds;
    ...
    private static void UpdateMatrix() {
        StaticZoom = WindowBounds.Height / 1080f;
