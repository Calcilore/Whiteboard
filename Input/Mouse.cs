...
public static class Mouse {
    public static Point WindowPosition { get; private set; }
    ...
    public static void Update() {
        ...
        // funny window things
        WindowPosition = ms.Position;
        Position = ((ms.Position - Main.Game.Window.ClientBounds.Size.Div(2)).ToVector2() / Camera.Zoom + Camera.Position).ToPoint();

        LeftButton   = ms.LeftButton   == ButtonState.Pressed;
        RightButton  = ms.RightButton  == ButtonState.Pressed; 
